...
import {SHIPMENTS_SELLER_LIST} from '../../../ActionsName.js';
...
let View = ({statictics_shipments_seller,dispatch}) => {
...
function mapStateToProps({statictics_shipments_seller}) {
  return {statictics_shipments_seller};
};
