...
const List = ({data,_meta,page,monthOnPageChange,loading, total, current, onShowItem, onEditItem}) => {
// 表格的列
  const columns = [
  {
    "title": "商家名称",
    ...
    "key": "seller.name",
    // render: (text, record) => (
    //   {/*<Link to={"/business/seller/list"}>{text}</Link>*/}
    // )
  }, {
    "title": "成交订单量",
