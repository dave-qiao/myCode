...
let View = ({ business_courier, dispatch }) => {
  ...
  const underTeamList = teams_info ? teams_info : [];
            ...
            <Row>
              <Col sm={12}>
                <FormItem label="城市" {...{ "labelCol": { "span": 4 }, "wrapperCol": { "span": 8 } }}>
                  {getCityNameByCode(account_detail.city_code)}
                </FormItem>
              ...
              <Col sm={12}>
                <FormItem label="所属团队" {...{ "labelCol": { "span": 4 }, "wrapperCol": { "span": 12 } }}>
                  {
                    underTeamList.map(function (item, index) {
                      return (
                        <span key={index}>
            ...
            <Row type="flex" justify="center">
              ...
              <Col sm={12}>
                <FormItem label="示例图片" {...{ "labelCol": { "span": 4 }, "wrapperCol": { "span": 8 } }}>
                  <img src='./images/example_id_card2.jpg' {...{
              ...
              <Col sm={12}>
                <FormItem label="示例图片" {...{ "labelCol": { "span": 4 }, "wrapperCol": { "span": 8 } }}>
                  <img src='./images/reverse_id_card.jpg' {...{
                    style: { width: '400px', height: '300px' },
                    alt: "无上传图片"
                  }}/>
                </FormItem>
              ...
              <Col sm={12}>
                <FormItem label="示例图片" {...{ "labelCol": { "span": 4 }, "wrapperCol": { "span": 8 } }}>
                  <img src='./images/example_id_card1.jpg' {...{
                    style: { width: '400px', height: '300px' },
                    alt: "无上传图片"
                  }}/>
                </FormItem>
