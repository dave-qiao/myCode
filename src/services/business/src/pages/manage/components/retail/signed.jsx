...
import { sqlit } from '../../../../../../../utils/newUtils.js';
...
class Signed extends Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    const { retailSellerInfo } = nextProps;
    const { signedInfos } = retailSellerInfo;
  ...
  render() {
    ...
    const { signedInfoData, signedInfos, seller_id, contract_id }=retailSellerInfo;
    const basicInfoData = signedInfoData;
    ...
    let price = signedInfos.price_plan.length != 0 ? signedInfos.price_plan[0].base_price : ''; // 一口价金额大小
      ...
      <div className="con-body main-list">
        ...
        <div className="bd-content">
          <div className={style.retail}>
            <h4 className={style.navLeftBorder}>产品定价</h4>
