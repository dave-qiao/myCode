...
class KnightRulesList extends Component {
  ...
  render() {
    ...
    for (var i = 0; i < editKnightRule.sub_area_list.length; i++) {
      sub_area_list_value.push({ id: editKnightRule.sub_area_list[i].id, name: editKnightRule.sub_area_list[i].name })
                ...
                <FormItem label="适用区域:" {...{ "labelCol": { "span": 8 }, "wrapperCol": { "span": 9 } }}>
                  ...
                  <Select
                    ...
                    {...getFieldProps("area_id", {
                      validate: [
                        { rules: [{ type: 'array', required: true, message: '请选择服务区域' },], trigger: 'onBlur', },
                      ],
