...
const View = ({ tms_control_panel, dispatch }) => {
	// 从model获取details信息
	const { shipment_detail, pushOrderDetails = { data: [] }, shipment_log = { data: [] }, shipment_area } = tms_control_panel;
	...
	const pushOrderColumns = [
		{
			...
			sorter: (a, b) => {
				let result_a = prctoMinute(a.created_at, 3);
				let result_b = prctoMinute(b.created_at, 3);
		...
		<div className="con-body">
			...
			<div className="bd-content">
				<Form horizontal className="main-form">
					...
					<h3 className="form-divider-header" style={{ margin: '0px' }}>推单记录</h3>
					<br />
					<Row type="flex" justify="center">
						<Col sm={22}>
							<Table
								columns={pushOrderColumns}
								dataSource={push_order_details}
							/>
						</Col>
					</Row>
