...
import {SHIPMENTS_COURIER_LIST} from '../../../ActionsName.js';
...
let View = ({statictics_shipments_courier,dispatch}) => {
...
function mapStateToProps({statictics_shipments_courier}) {
  return {statictics_shipments_courier};
};
