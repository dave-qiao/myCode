...
class View extends Component {
  ...
  render() {
    const {statictics_shipments_seller,business_public} = this.props;
    const {list_tables} = statictics_shipments_seller;
...
function mapStateToProps({statictics_shipments_seller,business_public}) {
  return {statictics_shipments_seller,business_public};
};
