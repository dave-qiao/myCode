...
import {SHIPMENTS_AREA_LIST} from '../../../ActionsName.js';
...
let View = ({statictics_shipments_area,dispatch}) => {
...
function mapStateToProps({statictics_shipments_area}) {
  return {statictics_shipments_area};
};
